...
INNER JOIN buy b ON l.ISBN = b.ISBN
GROUP BY l.ISBN
ORDER BY COUNT(b.id_buy) DESC";
...
<div class="container">
            ...
            <div class="col-book">
                <div class="product h-100">
                    ...
                    <div class="product-body d-flex flex-column">
                        ...
                        <?php } else { ?>
                            <div class="product-price">
                                <span class="new-price"><?php echo $prix; ?> $</span>
                            </div>
                        <?php } ?>
    ...
    <?php
        ...
        // Si la rangée n'est pas complète (moins de 5 livres), ajouter des cases vides pour maintenir l'alignement
