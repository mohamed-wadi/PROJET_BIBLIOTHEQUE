...
if ($_SERVER['REQUEST_METHOD'] == 'GET' && isset($_GET['Cherche_client_delete'])) {
    // Assurez-vous de valider et nettoyer toutes les données du formulaire
    $nom_client = isset($_GET['cherch']) ? mysqli_real_escape_string($connexion, $_GET['cherch']) : '';
    // Requête SQL pour chercher les détails de l'client
    $query_chercher_client = "SELECT * FROM client WHERE nom_client LIKE '%$nom_client%' or prenom_client LIKE '%$nom_client%'";
                    ...
                    <div class="form-box">
                        <div class="form-tab">
                            <ul class="nav nav-pills nav-fill" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link" id="signin-tab-2" data-toggle="tab" href="#signin-2" role="tab" aria-controls="signin-2" aria-selected="true">Delete User</a>
                                </li>
                            </ul>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <div class="input-group-append">
                                                        <button class="btn btn-outline-secondary" type="submit" id="deleteSearchButton" name="Cherche_client_delete">
